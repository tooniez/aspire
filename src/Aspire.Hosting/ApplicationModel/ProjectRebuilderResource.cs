...
/// </remarks>
internal sealed class ProjectRebuilderResource : ExecutableResource, IResourceWithParent<IResource>
{
    /// <summary>
    ...
    public ProjectRebuilderResource(string name, IResource parent, string projectPath)
