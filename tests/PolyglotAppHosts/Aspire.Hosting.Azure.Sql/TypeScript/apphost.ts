...
const _fullyQualifiedDomainName = await sqlServer.fullyQualifiedDomainName.get();
const _nameOutputReference = await sqlServer.nameOutputReference.get();
const _resourceId = await sqlServer.id.get();
