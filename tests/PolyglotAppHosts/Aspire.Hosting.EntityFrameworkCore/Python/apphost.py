...
with create_builder() as builder:
    ...
    api.add_ef_migrations("api-script-migrations").publish_as_migration_script()
    api.add_ef_migrations("api-script-options-migrations").publish_as_migration_script(
        idempotent=False,
        no_transactions=True)
    api.add_ef_migrations("api-bundle-migrations").publish_as_migration_bundle()
    api.add_ef_migrations("api-bundle-options-migrations").publish_as_migration_bundle(
